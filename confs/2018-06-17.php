...
(new Slides\Worship($ppt, '05_勝過這世界.ini'))->add();
(new Slides\Worship($ppt, '04_我要順服.ini'))->add();
(new Slides\Worship($ppt, '05_聖靈的江河.ini'))->add();
// 主日
(new Slides\Opening($ppt))->add(); // 關手機
(new Slides\Hymn($ppt, 161))->add(); // 唱詩
(new Slides\Verse($ppt, '徒', 4, 1, 37))->add(); // 讀經
...
(new Slides\Preach( // 講道
    ...
    '陳小冬牧師',
	array(
	    new Slides\Verse($ppt, '徒', 4, 1, 37), // 讀經
    ), // 序言
    array(
        '看見引經據典的人---被聖靈充滿---精確解經的漁民' => array(
            (new Slides\Verse($ppt, '徒', 4, 10, 20)),
            (new Slides\Verse($ppt, '徒', 4, 25, 28)),
        ),
        '看見大有膽量的人---被聖靈充滿---大膽宣教的小民' => array(
            (new Slides\Verse($ppt, '徒', 4, 8, 13)),
            (new Slides\Verse($ppt, '徒', 1, 1, 8)),

        ),
        '看見大量傳道的人---被聖靈充滿---增添信徒的國民' => array(
            (new Slides\Verse($ppt, '徒', 4, 1, 10)),
            (new Slides\Verse($ppt, '徒', 2, 36, 42)),
        ),
        '看見全然獻上的人---被聖靈充滿---遵命奉獻的選民' => array(
            (new Slides\Verse($ppt, '徒', 4, 31, 36)),
            (new Slides\Verse($ppt, '太', 6, 19, 21)),
